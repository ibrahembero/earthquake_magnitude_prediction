<h1>This repo contains two project one for backend using FastApi to load an existing model and then take the parameters as new input after some processing and predict the magnitude
...
in backend project to set an api then consuming it using front end <h1>🦋 🌹
